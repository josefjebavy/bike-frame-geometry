...
(function () {
  const DICT = {
    cs: {
      ...
      introNote: "Rozbal si kategorii výše a tlačítkem „+“ přidej další kola, přidej prázdné ručně, nebo přes „Import JSON“ načti vlastní soubor. Aktivní kolo se kreslí plnou barvou a jde upravovat dole ve formuláři, ostatní kola se kreslí poloprůhledně na pozadí pro porovnání.",
    ...
    en: {
      ...
      introNote: "Expand a category above and use the “+” to add more bikes, add a blank one manually, or use “Import JSON” to load your own file. The active bike is drawn in full color and can be edited in the form below; other bikes are drawn semi-transparent in the background for comparison.",
